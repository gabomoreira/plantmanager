      ...
      <View style={styles.container}>
        ...
        <View style={styles.controller}>
          <View style={styles.tipContainer}>
            <Image
              source={{
                uri: 'https://www.freepnglogos.com/uploads/drop-png/waterdrop-sharp-glimpse-illustration-transparent-png-8.png',
              }}
          ...
          <Button title="Confirmar" onPress={handleSavePlant} />
        </View>
      </View>
    </ScrollView>
  );
